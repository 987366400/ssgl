...
<FORM id=adminlogin  method=post
	name=adminlogin action="yhb?action=login"  >
<DIV></DIV>
	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<DIV style="MARGIN: 0px auto; WIDTH: 936px"><IMG
				style="DISPLAY: block" src="images/body_04.jpg"></DIV>
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${yhb.dlm}" name="dlm" id="dlm"></TD>
					</TR>
					<TR>
						<TD><INPUT type="password" class=input value="${yhb.dlmm }" name="dlmm" id="dlmm"/></TD>
					</TR>
					<TR>
						<td>
							<select id="yhsf" name="yhsf" class="input" style="margin-top: 15px;height: 24px">
								<option value="">请选择用户类型...</option>
								<option value="管理员"  ${'管理员'==yhb.yhsf?'selected':'' }>管理员</option>
								<option value="学生"  ${'学生'==yhb.yhsf?'selected':'' }>学生</option>
							</select>
						</td>
					</TR>
				</TBODY>
